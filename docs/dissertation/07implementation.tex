...
The JavaScript closure in the lambda term is represented as a string (Section \ref{sec:term-representation}), which is not evaluated until the lambda term is called.
